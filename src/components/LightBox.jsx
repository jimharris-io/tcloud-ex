export default function LightBox({contents, close}){
    ...
    if(contents.media === "photo"){
        ...
        photo = <a data-flickr-embed href={href}>
            <img src={src} width="640" height="360" alt="Time lapse sky"/>
        </a>
    }

    return (
        <section onClick={close} className="bg-black text-white fixed bg-opacity-80 z-50 w-full h-full flex items-center justify-center">
